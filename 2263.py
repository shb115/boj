...
def findpreorder(in_start, in_end, post_start, post_end): #preorder를 출력하는 함수, 
    ...
    findpreorder(in_start, in_start + left - 1, post_start, post_start + left - 1)  #새로운 앞 배열에 맞게 preorder 찾기
    findpreorder(in_end - right + 1, in_end, post_end - right, post_end - 1)        #새로운 뒷 배열에 맞게 preorder 찾기
...
findpreorder(0, n - 1, 0, n - 1) #전체부터 시작
